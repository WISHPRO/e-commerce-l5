                    ...
                    <div class="col-md-4 col-md-offset-2 col-xs-12 r1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="last_name" name="last_name" class="form-control" maxlength="20"
                                   placeholder="Enter your second name" value="{{ old('last_name') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="town" name="town" class="form-control" maxlength="20"
                                   placeholder="It should exist within your selected county">
                            @if($errors->has('town'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="home_address" name="home_address" rows="4"
                                      placeholder="Enter your home address" maxlength="100"
                    ...
                    <div class="col-md-4 col-xs-12 r2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation"
                                   class="form-control" maxlength="20" placeholder="Repeat your password">
