    ...
    <div class="col-md-{{ $size }} main-slider">
        <div id="owl-main-slider" class="owl-carousel owl-theme">

            <div class="item">
                <img src="assets/images/sliders/1536484200_1380798419.jpg" alt="The Last of us">
            ...
            <div class="item">
                <img src="assets/images/sliders/Galaxy_S5.jpg" alt="GTA V">
                <div class="container-fluid">
                    <div class="caption bg-color vertical-center text-left">
                        <div class="big-text fadeInDown-1">
                            The new <span class="highlight">imac</span> for you
            ...
            <div class="item">
                <img src="assets/images/sliders/HT1ooSuFv8gXXagOFbX4.jpg" alt="Mirror Edge">
                <div class="container-fluid">
                    <div class="caption bg-color vertical-center text-left">
                        <div class="big-text fadeInDown-1">
                            The new <span class="highlight">imac</span> for you
