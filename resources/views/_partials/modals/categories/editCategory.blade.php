<div class="modal" id="{{ $elementID }}" tabindex="-1" role="dialog" aria-labelledby="{{ $elementID. "Label" }}"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::model($category, ['url' => action('Backend\CategoriesController@update'), 'id' => 'CategoriesEditForm', 'class' => 'updateAction']) !!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="infoModalLabel">Editing {{ $category->name }}</h4>
