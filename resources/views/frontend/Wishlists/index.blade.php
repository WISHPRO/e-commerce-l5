            ...
            <div class="my-wishlist-page inner-bottom-sm">
                <div class="row">
                    <div class="col-md-12 my-wishlist">
                        ...
                        <p class="text text-center">If you already have a wishlist, please <a
                                    href="{{ route('login') }}">sign in</a> to view It </p>
                        <hr/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Let your friends know what you love most, using the many social platforms that
                                        you love
                                    </p>
                                </div>
                            </div>
