            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col-lg-8 col-sm-6">
                    ...
                    <section id="who-we-are" class="section m-t-0">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam quis diam erat. Duis velit
                            lectus, posuere a blandit sit amet, tempor at lorem. Donec ultricies, lorem sed ultrices
                            interdum. Leo metus luctus sem, vel vulputate diam ipsum sed lorem. Donec tempor arcu nisl,
                            et molestie massa scelerisque ut. Nunc at rutrum leo. Mauris metus mauris, tristique quis
                            sapien eu, rutrum vulputate enim.</p>
                        ...
                        <p>Mauris tempus erat laoreet turpis lobortis, eu tincidunt erat fermentum. Aliquam non
                            ...
                            Praesent varius ultrices massa at faucibus. Aenean dignissim, orci sed faucibus pharetra,
                            dui mi dignissim tortor, sit amet condimentum mi ligula sit amet augue.</p>
                    </section>
                    <!-- /#who-we-are -->
                    ...
                    <section id="our-goal-and-idea" class="section">
                        ...
                        <p>Donec libero dolor, tincidunt id laoreet vitae, ullamcorper eu tortor. Maecenas pellentesque,
                            dui vitae iaculis mattis, tortor nisi faucibus magna, vitae ultrices lacus purus vitae
                            metus. Ut nec odio facilisis, ultricies nunc eget, fringilla orci. Nulla lobortis sem
                            dapibus, aliquet turpis eu, ornare neque. Sed nec sem diam. Mauris neque purus, malesuada at
                            velit vel, tempus congue nisl. Ut aliquam semper augue hendrerit varius. Fusce pretium
                            tempus volutpat. Vivamus dignissim posuere aliquet. In hac habitasse platea dictumst. </p>
                    </section>
                    <!-- /#our-goal-and-idea -->
                    ...
                    <section id="our-team">
                        ...
                        <ul class="team-members list-unstyled">
                            ...
                            <li class="team-member">
                                ...
                                <div class="profile">
                                    <h3>Smith John
                                        <small class="designation">Support Staff</small>
                                    </h3>
                                    <ul class="social list-unstyled">
                                        <li>
                                            <a href="http://facebook.com/">
                        ...
                        <ul class="services list-unstyled row m-t-35">
                            <li class="col-md-4">
                                <div class="service">
                                    ...
                                    <p>Sed in mi rutrum, mattis eros ut, sagittis orci. Suspendisse vehicula auctor leo,
                                        nec egestas tellus fringilla ac integer.</p>
                                </div>
                            </li>
                            <li class="col-md-4">
                                <div class="service">
