                        ...
                        @if($subcategory->products->isEmpty())
                            <div class="row">
                                <div class="alert alert-info alert-dismissable" id="dismiss">
                                    ...
                                    <p class="text text-center">Ohh. <span class="fa fa-frown-o"></span>. we currently have no products belonging to '{{ beautify($subcategory->name) }}'. We promise to restock as soon as possible</p>
                                </div>
