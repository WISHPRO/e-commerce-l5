...
trait ReconcilerTrait
{
     ...
     * @return Money
     */
    public function getPriceAfterTax(Product $product, $quantity = 1)
    {
        return $this->tax($product)->add($this->value($product))->multiply($quantity);
    }
     ...
     * @return Money
     */
    public function getPriceAfterTaxAndDiscount(Product $product, $quantity = 1)
    {
        return $this->getPriceAfterTax($product)->subtract($this->discount($product))->multiply($quantity);
    }
